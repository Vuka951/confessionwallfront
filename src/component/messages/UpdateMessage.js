...
class UpdateMessage extends Component {
    ...
    async componentDidMount() {
        ...
        console.log(_id)
        const res = await axios.get(`https://vuka-projects-vukateam.c9users.io/api/posts/${_id}`);
    ...
    onSubmit = async (dispatch, e) => {
        ...
        const res = await axios.put(`https://vuka-projects-vukateam.c9users.io/api/posts/${_id}`, updatedMessage);
